...
| <code><a href="#@gemeentenijmegen/webapp.Webpage.criticalitySuffix">criticalitySuffix</a></code> | *No description.* |
...
##### `criticalitySuffix` <a name="criticalitySuffix" id="@gemeentenijmegen/webapp.Webpage.criticalitySuffix"></a>

```typescript
public criticalitySuffix(criticality: string): string
```

###### `criticality`<sup>Required</sup> <a name="criticality" id="@gemeentenijmegen/webapp.Webpage.criticalitySuffix.parameter.criticality"></a>
...
```typescript
public monitor(applicationName: string, filterPattern?: IFilterPattern, criticality?: string): void
```
...
###### `criticality`<sup>Optional</sup> <a name="criticality" id="@gemeentenijmegen/webapp.Webpage.monitor.parameter.criticality"></a>
...
| <code><a href="#@gemeentenijmegen/webapp.WebpageProps.property.criticality">criticality</a></code> | <code>string</code> | Override the criticality for monitoring of this part of the webapp. |
...
##### `criticality`<sup>Optional</sup> <a name="criticality" id="@gemeentenijmegen/webapp.WebpageProps.property.criticality"></a>
...
Override the criticality for monitoring of this part of the webapp.
